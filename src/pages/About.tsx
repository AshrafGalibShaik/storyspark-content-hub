  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        ...
        <section className="py-16 bg-cream">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div>
                <h2 className="text-3xl font-serif font-bold text-navy mb-6">Our Mission</h2>
              ...
              <div className="relative">
                <div className="absolute -top-4 -left-4 w-32 h-32 bg-teal/20 rounded-full z-0"></div>
                <img 
        ...
        {/* Features Section */}
        <section className="py-16 bg-light-gray/20">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-serif font-bold text-navy mb-12 text-center">Why Choose StoryHub?</h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <h3 className="text-xl font-medium text-navy mb-3">Powerful Editor</h3>
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <h3 className="text-xl font-medium text-navy mb-3">Vibrant Community</h3>
                <p className="text-navy/70">
              ...
              <div className="bg-white p-6 rounded-lg shadow-sm">
                ...
                <h3 className="text-xl font-medium text-navy mb-3">Engagement Features</h3>
                <p className="text-navy/70">
        ...
        <section className="py-16">
          <div className="container mx-auto px-4">
            <h2 className="text-3xl font-serif font-bold text-navy mb-12 text-center">Meet Our Contributors</h2>
            
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8">
              {users.map(user => (
                <div key={user.id} className="bg-white border border-light-gray/40 rounded-lg overflow-hidden shadow-sm transition-transform hover:-translate-y-1 duration-300">
                  <img 
                  ...
                  />
                  <div className="p-6">
                    <h3 className="text-xl font-medium text-navy mb-2">{user.name}</h3>
                    <p className="text-navy/70 mb-4 line-clamp-2">{user.bio}</p>
        ...
        <section className="py-16 bg-navy text-white">
          <div className="container mx-auto px-4 text-center">
            <h2 className="text-3xl font-serif font-bold mb-6">Join Our Community Today</h2>
